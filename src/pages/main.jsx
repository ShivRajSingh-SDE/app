...
export default function Main() {
  ...
  return (
    <div
      id="main"
      className=" max-w-[1200px] z-[-1] mx-auto md:flex flex-row justify-between md:h-screen items-center  "
    >
      <div className="relative">
        <div class="card ">
          <div class="background"></div>
          <div class="logoimg">
            <h1 className=" text-2xl ">𝕊ℍ𝕀𝕍</h1>
          </div>
          <div class="box box1">
            <span class="icon">
              <svg
        ...
        <div class="item-hints absolute md:-top-40 md:left-full display md:hidden ">
          <div class="hint" data-position="4">
            <span class="hint-radius"></span>
            <span class="hint-dot">Tip</span>
            <div class="hint-content do--split-children">
              <p>Take Your Mouse over Div</p>
            </div>
          </div>
        </div>
      </div>

      <div className="flex flex-col md:w-[50%] justify-center items-center f">
        <div className=" flex flex-col justify-center items-center float-left">
          <h1
            id="textstyle"
            className=" font-bold relative text-[#4f47c565]   text-[50px] md:text-[79px]"
          >
            SHIVRAJ SINGH
          </h1>
